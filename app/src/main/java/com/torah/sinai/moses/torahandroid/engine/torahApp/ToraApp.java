...
import com.torah.sinai.moses.torahandroid.engine.ioManagement.ExcelFunctions;
...
import com.torah.sinai.moses.torahandroid.engine.ioManagement.PropStore;
...
public class ToraApp {
	...
	public static final String ToraLetterFile = resourceFolder + "no_tevot.txtt";
	public static final String ToraTables = resourceFolder + "torah_tabless.xls";
	...
	public static LineReport returnBookInfoExtraIndexes(String searchStringTitle, int countLines, LineHtmlReport lineHtmlReport, ArrayList<Integer[]> addIndexes) {
		...
		try {
			...
			String tempStr1 = "\u202B" + "\"" + Output.markText(searchStringTitle, ColorClass.markupStyleHTML)
					+ "\" " + "נמצא ב"
					+ Output.markText(
	...
	public static class perekBookInfo {
		...
		public static String findLetters(int num) {
			...
			case 16:
				return "טז";
			default:
				return (Character.toString(letters[1][num / 10]) + letters[0][num % 10])
						.replaceAll("\\s+", "");
			}
		}
